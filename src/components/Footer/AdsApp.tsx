...
const AdsApp = () => {
  ...
  return !isVisible ? (
    ...
    >
      <div className={'lg:w-2/3 md:max-lg:w-3/4 h-full bg-white'}>
        <div className="w-full h-full flex justify-around items-center lg:p-5 md:max-lg:p-1">
          <div
            className={
              'w-3/5 text-4xl text-emerald-600 flex flex-col justify-between'
            }
          >
            <div>
              Trải nghiệm App chăm sóc sức khỏe của chúng tôi miễn phí trong 14
              ngày.
            </div>
            <div className={'w-full text-emerald-600 text-lg mt-10'}>
              ...
              >
                <Link
                  to={''}
                  className={
                    'min-w-40 md:max-lg:w-1/2 bg-emerald-600 rounded-md p-2 text-white flex flex-row justify-around items-center mr-1'
                  }
                >
                  <div
                    className={
                ...
                <Link
                  to={''}
                  className={
                    'min-w-40 md:max-lg:w-1/2 bg-emerald-600 rounded-md p-2 text-white flex flex-row justify-around items-center ml-1'
                  }
                >
                  <div
                    className={
    ...
    <div
      className={'flex justify-center items-center w-full h-ful bg-white p-2'}
    >
      <div className={'w-10/12/12 flex justify-center items-center'}>
        {/*this is a text*/}
        <div className={'w-1/2 p-2 text-emerald-600 text-xl'}>
          {' '}
          Trải nghiệm App chăm sóc sức khỏe của chúng tôi ngay.
        </div>
        ...
        <div className={'w-1/2 flex justify-center items-center p-2'}>
          <Link
            to={''}
            className={
              'w-3/4 bg-emerald-600 rounded-md p-2 text-white flex flex-row justify-around items-center mr-1'
            }
          >
