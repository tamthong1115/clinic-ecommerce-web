...
const DoctorsByService = lazy(
  () => import('../../pages/publicPages/DoctorsByService.tsx')
);
const CreateAppointment = lazy(
  () => import('../../pages/publicPages/CreateAppointment.tsx')
);
...
const PublicRoutesComponent = () => {
  return (
    <>
      ...
      <Route
        path={PublicPaths.DOCTORS_BY_SERVICE(':serviceId')}
        element={<DoctorsByService />}
      />{' '}
      ...
      <Route
        path={PublicPaths.ABOUT_FOR_CONTACT}
        element={<AboutForContact />}
      />
      <Route
        path={PublicPaths.ABOUT_FOR_cooperation}
        element={<AboutForCooperation />}
      />
      <Route
