...
const Footer = () => {
    const [hideContent, setHideContent] = useState([true, true, true, true, true, true]);
    ...
    const showContent = (key: number) => {
        if (windowWidth <= limitDesktop) {
            setHideContent((prev) => {
                const newContent = [...prev]; // Tạo một bản sao của mảng hiện tại
                newContent[key] = !newContent[key]; // Cập nhật giá trị tại vị trí 'key' thành 'true'
                return newContent; // Trả về mảng đã cập nhật
            });
        }
    }

    const getMotionConfig = (isHidden: boolean, isMobile: boolean) => ({
        initial: {
    ...
    return (
        <div className="flex flex-col w-full justify-center items-center bg-white text-black">
            ...
            <div
                ...
                <div className="text-left ms:max-lg:w-full">
                    <div
                        ...
                        onClick={() => showContent(0)}>Công ty Cổ phần Công nghệ 4ChillyGuys
                        <MotionConfig>
                            <AnimatePresence initial={false}>
                                {!hideContent[0] ? (
                                    <motion.ul
                                        ...
                                        <li className="flex flex-row ml-2 items-center leading-8  text-gray-800">
                                            <BsIcon.BsEnvelopeAt className={'mx-1'}/> fucking@fmail.cnd
                                        </li>
                                        <li>
                                            <h4 className={' leading-8 font-bold'}>Văn phòng tại TP. Hồ Chí Minh</h4>
                                            <div className="flex flex-row ml-2 items-center leading-8  text-gray-800">
                                                <BsIcon.BsGeoAlt className={'mx-1'}/> chilli powder
                                            </div>
                                        </li>
                                        <li>
                                            <h4 className={' leading-8 font-bold'}>Văn phòng tại TP. Hà Nội</h4>
                                            <div className="flex flex-row ml-2 items-center leading-8  text-gray-800">
                                                <BsIcon.BsGeoAlt className={'mx-1'}/> chilli powder
                                            </div>
                                        </li>
                ...
                <div className="text-left ms:max-lg:w-full">
                    ...
                    <MotionConfig>
                        <AnimatePresence initial={false}>
                            {!hideContent[1] ? (
                                <motion.ul
                                    {...getMotionConfig(hideContent[1], windowWidth <= limitDesktop)}
                                    className={'list-none lg:max-xl:p-2 m-0 text-cyan-600'}>
                                    <li className={'leading-8'}><Link to={''}>Liên hệ hợp tác</Link></li>
                                    <li className={'leading-8'}><Link to={''}>Chuyển đổi số</Link></li>
                                    <li className={'leading-8'}><Link to={''}>Chính sách bảo mật</Link></li>
                                    <li className={'leading-8'}><Link to={''}>Quy chế hoạt động</Link></li>
                                    <li className={'leading-8'}><Link to={''}>Tuyển dụng</Link></li>
                                    <li className={'leading-8'}><Link to={''}>Điều khoản sử dụng</Link></li>
                                    <li className={'leading-8'}><Link to={''}>Câu hỏi thường gặp</Link></li>
                                    <li className={'leading-8'}><Link to={''}>Sức khỏe doanh nghiệp</Link></li>
                                </motion.ul>) : null}
                        </AnimatePresence>
                    </MotionConfig>
                </div>
                <div className="text-left md:max-lg:w-full">
                    <div
                        className={'font-bold w-full border xl:border-0 p-2 xl:p-0 cursor-pointer xl:cursor-text'}
                        onClick={() => showContent(2)}>Đối tác bảo trợ nội dung
                    </div>
                    <MotionConfig>
                        <AnimatePresence initial={false}>
                            {!hideContent[2] ? (
                                <motion.ul
                                    {...getMotionConfig(hideContent[2], windowWidth <= limitDesktop)}
                                    ...
                                    <li className={'mt-1'}>
                                        <Link to={''}
                                            ...
                                            <div className={'ml-2.5'}>
                                                <div className={'font-bold leading-none'}>Hello Doctor</div>
                                    ...
                                    <li className={'mt-1'}>
                                        <Link to={''}
                                            ...
                                            <BsIcon.BsFilePerson size={20} className={'mx-1'}/>
                                            <div className={'ml-2.5'}>
                                                <div className={'font-bold leading-none'}>Hệ thống y khoa chuyên sâu
                                                    Quốc tế
                                                    Bernard
                                                </div>
                                                <div>Bảo trợ chuyên mục nội dung "y khoa chuyên sâu"</div>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className={'mt-1'}>
                                        <Link to={''}
                                            ...
                                            <BsIcon.BsFilePerson size={20} className={'mx-1'}/>
                                            <div className={'ml-2.5'}>
                                                <div className={'font-bold leading-none'}>Doctor Check - Tầm Soát Bệnh
                                                    Để
                                                    Sống
                                                    Thọ
                                                    Hơn
                                                </div>
                                                <div>Bảo trợ chuyên mục nội dung "sức khỏe tổng quát"</div>
                                            </div>
                                        </Link>
                                    </li>
                                </motion.ul>
                ...
                <div className={'text-left md:max-lg:w-full'}>
                    <div
                        className={'font-bold w-full border xl:border-0 p-2 xl:p-0 cursor-pointer xl:cursor-text'}
                        onClick={() => showContent(3)}>Tổng đài
                    </div>
                    <MotionConfig>
                        <AnimatePresence initial={false}>
                            {!hideContent[3] ? (
                                <motion.ul
                                    {...getMotionConfig(hideContent[3], windowWidth <= limitDesktop)}
                                    className={'list-none p-2 m-0 text-gray-800'}>
                                    <li>
                                        <div className="flex flex-row justify-start items-center">
                                            <BsIcon.BsTelephone className={'mr-1'}/> Tư vấn dịch vụ
                                        </div>
                                        <div><strong className={'text-emerald-600'}>18003508</strong> (nhánh 1)</div>
                                    </li>
                                    <li>
                                        <div className="flex flex-row justify-start items-center">
                                            <BsIcon.BsTelephone className={'mr-1'}/> Trung tâm hỗ trợ khách hàng
                                        </div>
                                        <div><strong className={'text-emerald-600'}>18003508</strong> (nhánh 2)</div>
                                    </li>
                                    <li>
                                        <div className="flex flex-row justify-start items-center">
                                            <BsIcon.BsTelephone className={'mr-1'}/> Đặt lịch hẹn
                                        </div>
                                        <div><strong className={'text-emerald-600'}>18003508</strong> (nhánh 3)</div>
                                    </li>
                                </motion.ul>) : null}
                        </AnimatePresence>
                    </MotionConfig>
                ...
                <div
                    ...
                    <div className={'xl:mr-1 xl:p-2 w-full'}>
                        <div
                            ...
                            onClick={() => showContent(4)}>Chứng nhận an toàn
                        </div>
                        <MotionConfig>
                            <AnimatePresence initial={false}>
                                {!hideContent[4] ? (
                                    <motion.div
                                        {...getMotionConfig(hideContent[4], windowWidth <= limitDesktop)}
                    ...
                    <div className={' ml-0 xl:ml-1 xl:p-2 w-full'}>
                        <div
                            className={'text-left xl:text-center font-bold w-full border xl:border-0 p-2 xl:p-0 cursor-pointer xl:cursor-text'}
                            onClick={() => showContent(5)}>Hỗ trợ thanh toán
                        </div>
                        <MotionConfig>
                            <AnimatePresence initial={false}>
                                {!hideContent[5] ? (
                                    <motion.div
                                        {...getMotionConfig(hideContent[5], windowWidth <= limitDesktop)}

                                        className={'grid grid-cols-4 lg:max-xl:grid-cols-8    text-gray-800'}>
            ...
            <div
                className="flex justify-around items-center flex-row w-full min-h-10 mt-2.5 px-5 pb-3 pt-2 bg-gray-800 text-white">
