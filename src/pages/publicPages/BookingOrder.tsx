...
const detailValidate = Yup.object().shape({
  ...
  birth: Yup.string()
    ...
    .min(4, 'Năm sinh phải có ít nhất 4 ký tự'),
  ...
  date: Yup.date()
    .min(today, 'Ngày phải lớn hơn hoặc bằng ngày hiện tại')
          ...
          <div className="flex items-center justify-center w-[100%] mx-auto  border-b-2 border-gray-200 pb-[20px] px-[20px]">
            ...
            <div className="mb-[5px]">
              <div className="text-[25px] text-[#555555] font-[700] flex items-center">
                ...
                <div className="ml-[5px]">Đặt lịch khám</div>
              </div>
              ...
              <div className="">
                <div className="text-[#555555] font-[600] text-[18px] flex items-center mb-[5px]">
                  ...
                  <div className="ml-[5px]">{sampleData.clinic}</div>
                </div>
                <div className="flex items-center">
                  <FaRegBuilding />
                  <div className="ml-[5px]">{sampleData.address}</div>
                </div>
              </div>
            </div>
          </div>
            ...
            >
              {({ errors, touched }) => (
                <Form className="w-full">
                  <label
                    htmlFor="fullName"
                    className="mb-[5px] block text-[#606060] font-[600]"
                  >
                    Họ và tên:
                  </label>
                  <Field
                    ...
                    className={`border border-gray-200 w-full h-[52px] px-[22px] rounded-md bg-[#f5f6fa] outline-none ${
                  ...
                  <label
                    htmlFor="email"
                    className="mb-[5px] mt-[10px] block text-[#606060] font-[600]"
                  >
                    Email:
                  </label>
                  <Field
                  ...
                  <Field
                    ...
                    name="address"
                    id="address"
                    placeholder="VD: 1/p, Nguyễn Hữu Cầu, Bà Điểm, Hoóc Môn"
                    className={`border border-gray-200 w-full h-[52px] px-[22px] rounded-md bg-[#f5f6fa] outline-none ${
                  ...
                  <Field
                    ...
                    name="reason"
                    id="reason"
                    placeholder="VD: Đau tay, đau chân, chóng mặt...."
                    className={`border border-gray-200 w-full h-[100px] px-[22px] pt-[20px] rounded-md bg-[#f5f6fa] outline-none ${
